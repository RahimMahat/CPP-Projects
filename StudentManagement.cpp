...

{
    ...
    fout.open("Stu.txt",ios::out|ios::app);// open file in append mode
...

{
    ...
    fin.open("Stu.txt",ios::in); // open file in input mode
...

{
    ...
    while(fin.read((char*)&s,sizeof(s))) // read the file
    ...
    if(n==s.getAdmno())
    {
        ...
        tout.write((char*)&s,sizeof(s)); // write data
...

    {
        ...
        fout.write((char*)&s,sizeof(s)); // write data
